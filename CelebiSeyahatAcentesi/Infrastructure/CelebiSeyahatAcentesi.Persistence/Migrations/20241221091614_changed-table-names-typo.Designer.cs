...
namespace CelebiSeyahat.Persistence.Migrations
{
    ...
    [Migration("20241221091614_changed-table-names-typo")]
    partial class changedtablenamestypo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CelebiSeyahat.Domain.Entities.City", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CelebiSeyahat.Domain.Entities.District", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CelebiSeyahat.Domain.Entities.District", b =>
                {
                    b.HasOne("CelebiSeyahat.Domain.Entities.City", "City")
                        .WithMany("Districts")
