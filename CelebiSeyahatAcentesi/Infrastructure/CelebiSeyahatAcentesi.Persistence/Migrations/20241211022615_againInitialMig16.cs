...
{
    /// <inheritdoc />
    public partial class againInitialMig16 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportationCompanys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransportationCompanyId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TransportationType = table.Column<int>(type: "int", nullable: false),
                    CreatedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TransportationCompanyId",
                table: "Tickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_TransportationCompanyId",
                table: "Trips",
                column: "TransportationCompanyId");
        }
